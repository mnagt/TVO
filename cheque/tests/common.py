...
class L10nLatamCheckTest(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        third_party_checks_journals = cls.env['account.journal'].search([
            ('inbound_payment_method_line_ids.code', '=', 'cheque_existing_in'),
            ('inbound_payment_method_line_ids.code', '=', 'cheque_incoming'),
            ('outbound_payment_method_line_ids.code', 'in', ('cheque_existing_out', 'cheque_return')),
        ])
